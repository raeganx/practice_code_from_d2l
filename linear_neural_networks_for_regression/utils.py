...
class HyperParameters:
    ...
    # usage: self.save_hyperparameters(ignore=['c'])
...
class ModelModule(nn.Module, HyperParameters):
...
class Trainer(HyperParameters):
    ...
    key method:fit(), which accepts an instance of ModelModule and an instance of DataModule
